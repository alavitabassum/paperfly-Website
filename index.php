<?php include 'modHeader.php';?>
    <div id="sliderContainer">
        ...
        <div id="sliderDotsPanel"> <span class="sliderDot" onclick="activeSlide=1;continuousSlideShow();"></span> <span class="sliderDot" onclick="activeSlide=2;continuousSlideShow();"></span> <span class="sliderDot" onclick="activeSlide=3;continuousSlideShow();"></span> <span class="sliderDot" onclick="activeSlide=4;continuousSlideShow();"></span></div> <span id="sliderPrevBtn" onclick="activeSlide--;continuousSlideShow();">&#10094;</span> <span id="sliderNextBtn" onclick="activeSlide++;continuousSlideShow();">&#10095;</span></div>
    <div class="promo-cards"><img class="promo" src="./img/8.jpeg"> <img class="promo" src="./img/7.jpg"> <img class="promo" src="./img/6.jpg"> <img class="promo" src="./img/3.jpg"> <img class="promo" src="./img/4.jpg"></div>
